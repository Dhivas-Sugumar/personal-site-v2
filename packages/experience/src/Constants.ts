...
export const experienceCards: ExperienceCardProps[] = [
    {
      ...
      description: 'Led a team of developers in creating a new cloud-based platform. Implemented microservices architecture and improved system performance by 40%.'
    },
    {
    ...
    },
    {
      ...
      location: 'Austin, TX',
      description: 'Assisted in the development of a mobile app using React Native. Participated in code reviews and implemented unit tests to ensure code quality.'
    }
  ];